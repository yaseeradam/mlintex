...
class QuickAddShopCustomerSheet extends ConsumerStatefulWidget {
  ...
  const QuickAddShopCustomerSheet({super.key, this.existing});

  @override
  ConsumerState<QuickAddShopCustomerSheet> createState() =>
      _QuickAddShopCustomerSheetState();
}

class _QuickAddShopCustomerSheetState extends ConsumerState<QuickAddShopCustomerSheet> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (_isEditing) {
        await ref.read(shopCustomerNotifierProvider.notifier).updateCustomer(
        ...
        await ref.read(shopCustomerNotifierProvider.notifier).addCustomer(
              name: name,
              phone: phone,
              address: address,
              shopNumber: shopNumber,
          ...
          child: ListView(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(hintText: 'e.g. Shop 12, Block B'),
              ),
              const SizedBox(height: 14),
